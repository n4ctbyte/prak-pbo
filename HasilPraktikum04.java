...
public class HasilPraktikum04 {
    ...
    public static void main(String[] args) {
        ...
        // Perbaikan: gunakan nextLine() setelah nextInt() untuk menghindari masalah input
        input.nextLine();
        ...
        // Contoh 1: Perulangan angka
        for (int i = 1; i <= 5; i++) {
            System.out.println("Perulangan ke-" + i);
        }

        System.out.println(); // Untuk baris kosong
        ...
        input.nextLine(); // Perbaikan: Membuang baris baru setelah nextInt()
        String password = "";
